...
export function PauseIcon() {
  return <Icon><path d="M8 5v14M16 5v14" stroke="currentColor" strokeLinecap="round" strokeWidth="2" /></Icon>;
}

export function ResetIcon() {
  return <Icon><path d="M5.5 8.5A7 7 0 1 1 5 15m.5-6.5V4m0 4.5H10" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.7" /></Icon>;
}

export function GitHubIcon() {
  return <Icon><path d="M12 2.8a9.2 9.2 0 0 0-2.9 17.9c.5.1.6-.2.6-.5v-1.8c-2.7.6-3.3-1.1-3.3-1.1-.4-1.1-1.1-1.4-1.1-1.4-.9-.6.1-.6.1-.6 1 0 1.5 1 1.5 1 .9 1.5 2.3 1.1 2.8.8.1-.6.4-1.1.6-1.3-2.2-.2-4.5-1.1-4.5-4.6 0-1 .4-1.9 1-2.5-.1-.3-.4-1.2.1-2.5 0 0 .8-.3 2.6 1a9 9 0 0 1 4.8 0c1.8-1.2 2.6-1 2.6-1 .5 1.3.2 2.2.1 2.5.7.7 1 1.5 1 2.5 0 3.5-2.3 4.3-4.5 4.6.4.3.7.9.7 1.7v2.6c0 .3.2.6.7.5A9.2 9.2 0 0 0 12 2.8Z" fill="currentColor" /></Icon>;
}
